...
#
def ExtractTextTableInfoWithFiguresTablesRenditionsFromPDF(filepath, filename):
    try:
        file = open(os.path.join(os.path.abspath(filepath), filename), 'rb')
        ...
        with open(os.path.join(os.path.abspath(filepath), filename), "wb") as file:
...
if __name__ == "__main__":
    ExtractTextTableInfoWithFiguresTablesRenditionsFromPDF('input','0610_m20_qp_42.pdf')
